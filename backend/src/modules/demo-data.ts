...
export const workers: WorkerEntity[] = [
  ...
  { id: 'w-chen', userId: 'u-worker-2', name: '陈洁', phone: '13800000003', specialties: [ServiceCategory.CLEANING], rating: 4.8, totalOrders: 286, status: WorkerStatus.ONLINE, bio: '长期服务家庭深度保洁和开荒保洁。', experience: 6, idCardNo: '330***********1221', createdAt: iso() },
  ...
  { id: 'w-wang', userId: 'u-worker-4', name: '王芳', phone: '13800000005', specialties: [ServiceCategory.CLEANING], rating: 4.9, totalOrders: 210, status: WorkerStatus.ONLINE, bio: '专注家庭深度保洁与收纳整理。', experience: 7, idCardNo: '320***********6642', createdAt: iso() },
  { id: 'w-sun', userId: 'u-worker-5', name: '孙强', phone: '13800000006', specialties: [ServiceCategory.MOVING, ServiceCategory.ERRAND], rating: 4.6, totalOrders: 167, status: WorkerStatus.ONLINE, bio: '搬家、跑腿样样精通，守时高效。', experience: 5, idCardNo: '510***********9087', createdAt: iso() }
];
...
export const orders: OrderEntity[] = [
  ...
  { id: 'ord-4', orderNo: 'HS-20260616-0003', serviceItemId: 'svc-errand-doc', customerId: 'u-customer', address: '上海市长宁区中山公园', addressDetail: '7号 301', contactPhone: '13800000001', scheduledTime: iso(25), status: OrderStatus.PENDING, totalPrice: 49, createdAt: iso(-1), updatedAt: iso(-1) },
  { id: 'ord-5', orderNo: 'HS-20260616-0004', serviceItemId: 'svc-clean-deep', customerId: 'u-customer', workerId: 'w-wang', address: '上海市普陀区长寿路', addressDetail: '200号 1108', contactPhone: '13800000001', scheduledTime: iso(20), status: OrderStatus.ASSIGNED, totalPrice: 268, createdAt: iso(-2), updatedAt: iso(-2) },
  { id: 'ord-6', orderNo: 'HS-20260616-0005', serviceItemId: 'svc-clean-deep', customerId: 'u-customer', address: '上海市虹口区四川北路', addressDetail: '15号 602', contactPhone: '13800000001', scheduledTime: iso(21), status: OrderStatus.PENDING, totalPrice: 268, createdAt: iso(-1), updatedAt: iso(-1) }
];
